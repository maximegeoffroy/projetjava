    ...
    public static void modifier(Connection connection, Offre offre) throws Exception{
        ...
        try {
           ...
           int id = 0;
            ...
            stmt = connection.createStatement();
            nb = stmt.executeUpdate("UPDATE Offre SET Intitule ='" + intitule +"', Reference='" + reference + "', DatePublication=" + datePublication + ", DureeDiffusion=" + dureeDiffusion + ", DateDebutContrat=" + dateDebutcontrat + ", NbPostes=" + nbPostes + ", Localisation='" + localisation + "', DescriptionPoste='" + descriptionPoste + "', DescriptionProfil='" + descriptionProfil + "', Telephone='" + telephone + "', Email='" + mail + "', IdentifiantType_Contrat=" + idTypeContrat + ", IdentifiantMetier=" + idMetier + ", IdentifiantDomaine_Metier=" + idDomaineMetier + ", IdentifiantAnnonceur=" + idAnnonceur + " WHERE Identifiant=" + identifiant);
